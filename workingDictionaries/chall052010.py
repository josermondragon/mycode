...
myName = classinfo['all'][6]["name"]
spiAni = classinfo['all'][6]["spirit animal"]
print(f"My name is {myName} and my spirit animal is {spiAni}"   )
print("***")
...
for x in classinfo["all"]:
    ...
    print(f"{name} is a/an {skill} {anim}")
